...
export default function AnomalyDetector() {
  ...
  const fetchStats = async () => {
    try {
      ...
      console.error(err);
      toast.error("Failed to load anomaly stats");
    }
  };
  ...
  useEffect(() => {
    ...
    socket.on("anomaly-alert", (payload) => {
      toast.warn(`Anomaly: ${payload.anomalyType} — ${payload.severity}`, {
        autoClose: 5000,
      });
      fetchRecords();
      fetchStats();
        ...
        <div className="bg-gradient-to-br from-slate-900/70 to-slate-800/70 rounded-2xl border border-slate-700/70 p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <select
              ...
              className="px-3 py-2 bg-slate-950/60 border border-gray-700 rounded-xl text-gray-200 outline-none focus:ring-2 focus:ring-cyan-500"
            >
